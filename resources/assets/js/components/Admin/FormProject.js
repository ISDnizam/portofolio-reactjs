  ...
  handleChange(e) {
    ...
    handleSubmit(e) {
      ...
      if(this.state.id_project){
        var uri_api = '/project/update_project';
        axios
            ...
            .then(response => {
                ...
                $('#returnmessage').html('<div className="alert alert-danger alert-dismissable"><strong>Update Project Failed !</strong> Please try again</div>');                    
                }
                $('#button_submit').html('Submit');

            });
      }else{
        var uri_api = '/project/create_project';
        axios
            ...
            .then(response => {
                ...
                $('#returnmessage').html('<div className="alert alert-danger alert-dismissable"><strong>Create Project  Failed!</strong> Please try again</div>');                    
                }
                $('#button_submit').html('Submit');
              ...
              <div className="row">
                <div className="col-12">
                  ...
                  <form className="form-sample" onSubmit={this.handleSubmit}>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-sm-9">
                            <input type="text" value={this.state.client}  className="form-control" name="client"   onChange={this.handleChange} />
                          </div>
                        </div>
                       ...
                       <div className="col-md-6">
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-sm-9">
                            <input type="" value={this.state.url}   className="form-control" name="url"   onChange={this.handleChange} />
                          </div>
                        </div>
                    ...
                    <Link className="btn btn-light" to={"/admin/project"}>Cancel</Link>
                  </form>
                </div>
              </div>
            </div>
